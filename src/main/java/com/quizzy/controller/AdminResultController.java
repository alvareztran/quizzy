...
public class AdminResultController {
    ...
    private final Paginator<ResultItemDTO> paginator = new Paginator<>(10);
    ...
    private void applyFilters() {
        paginator.setItems(getFilteredItems());
        updatePagination();
    }

    private void updatePagination() {
        displayedItems.setAll(paginator.getCurrentPageItems());
        view.getPaginationInfoLabel().setText(paginator.getPaginationInfoText("results"));
