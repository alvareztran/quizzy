...
public class QuestionController {
    ...
    private final Paginator<Question> paginator = new Paginator<>(10);
    ...
    private void renderPage() {
        displayedQuestionList.setAll(paginator.getCurrentPageItems());
        view.getPaginationInfoLabel().setText(paginator.getPaginationInfoText("questions"));
