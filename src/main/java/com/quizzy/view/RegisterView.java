...
public class RegisterView {
    ...
    private final PasswordInputField confirmPasswordField = new PasswordInputField("Enter your password again");
    ...
    public PasswordInputField getConfirmPasswordField() {
