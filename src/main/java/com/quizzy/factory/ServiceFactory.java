...
public class ServiceFactory {
    ...
    private static final ResultDetailService RESULT_DETAIL_SERVICE = new ResultDetailService(DAOFactory.getResultDetailDAO());
    ...
    public static ResultDetailService getResultDetailService() {
        return RESULT_DETAIL_SERVICE;
    }
